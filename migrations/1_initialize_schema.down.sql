...
DROP FUNCTION IF EXISTS delete_execution_statistics();
...
DROP TABLE IF EXISTS launch_attribute_rules CASCADE;
...
DROP TABLE IF EXISTS launch_number CASCADE;
DROP TABLE IF EXISTS launch_tag CASCADE;
DROP TABLE IF EXISTS item_tag CASCADE;

DROP TABLE IF EXISTS pattern_template_test_item CASCADE;
DROP TABLE IF EXISTS pattern_template CASCADE;
