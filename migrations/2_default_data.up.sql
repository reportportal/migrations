...
INSERT INTO synchronization_attributes(
...
INSERT INTO active_directory_config(
	...
	VALUES ((SELECT currval(pg_get_serial_sequence('integration', 'id'))), 'ldap://minsk.epam.com:3268', 'dc=epam,dc=com', (SELECT currval(pg_get_serial_sequence('synchronization_attributes', 'id'))), 'epam.com');
